...
4. **Install ImageMagick**
   ...
   Install ImageMagick, which is needed by MoviePy for text rendering in GIFs:
...
6. **Run Redis**
   ...
   Ensure Redis is running. You can start Redis with:
...
7. **Run MongoDB**
   ...
   Ensure MongoDB is running. You can start MongoDB with:
